...
import com.zh.commandbuidler.CommandAssembly;
import com.zh.commandbuidler.CommandAssemblyImpl;
import com.zh.commandbuidler.CommandBuidler;
import com.zh.data.CommandTasker;
import com.zh.data.TaskDao;
import com.zh.data.TaskDaoImpl;
import com.zh.handler.*;
...
//				keepAliveHandler.start();
	...
	public boolean stop(String id) {
		System.out.println("taskDao.isHave(id)"+taskDao.isHave(id));
		if (id != null && taskDao.isHave(id)) {
			System.out.println("debugc"+config.isDebug());
			if (config.isDebug())
				System.out.println("正在停止任务：" + id);
			CommandTasker tasker = taskDao.get(id);
			System.out.println("tasker"+tasker);
			System.out.println("tasker.getProcess()"+tasker.getProcess());
			System.out.println("tasker.getThread()"+tasker.getThread());
